...
Amara & Co. is a fictional South African clothing retail business offering everyday clothing and accessories. The website was developed as a responsive five-page e-commerce-style website designed to provide customers with information about the organisation, its products, enquiry options and contact information.
...
The website was developed using HTML5, CSS3 and JavaScript. Responsive web design techniques were implemented to ensure that the website adapts to desktop, tablet and mobile screen sizes.
...
* Simple navigation.
* Responsive browsing.
* Convenient enquiry and contact options.
...
It also includes a general contact form that allows visitors to submit messages.
...
* Error messages.
* Input processing.
* A user response after successful submission.
* AJAX form submission.
...
The foundation of the website was developed according to the Part 1 requirements.
...
The website was developed according to the Part 2 CSS and Responsive Design requirements.
...
Git was used throughout the development process to track changes to the website.

The project was maintained using a local Git repository and developed through multiple stages.

Descriptive commit messages were used to document development progress and major project changes.

The final project is intended to be pushed to the required GitHub repository.
...
All external sources used during the development of the project should be referenced using the Harvard Style Referencing Guide adapted for The Independent Institute of Education.
...
* Video link: https://www.shutterstock.com/video/clip-4080978879-medium-long-shot-stylish-young-caucasian-girls?trackingId=3a4dcea1-bb7e-4f12-8883-946db802fd7a&listId=searchResults
